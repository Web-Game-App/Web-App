  ...
  var n = function (e) {
    ...
    r = function (e, r) {
      var o = encodeURIComponent(e),
        ...
        a = window.open(
          "https://rosefire.csse.rose-hulman.edu/webview/login?platform=web&registryToken=" +
            o +
            "&referrer=" +
            i,
          "_blank"
        ...
        l = setInterval(function () {
          a.closed &&
            (clearInterval(l),
            r && (r(new Error("Login cancelled")), (r = null)));
        }, 500);
      window.addEventListener("message", function (e) {
        var o = e.origin || e.originalEvent.origin;
        if ("https://rosefire.csse.rose-hulman.edu" !== o)
          return void console.error("Invalid origin:" + o);
        var i = r;
